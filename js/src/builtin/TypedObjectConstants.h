...
#define JS_SCALARTYPEREPR_BIGINT64      6
#define JS_SCALARTYPEREPR_BIGUINT64     7
#define JS_SCALARTYPEREPR_FLOAT32       8
#define JS_SCALARTYPEREPR_FLOAT64       9
#define JS_SCALARTYPEREPR_UINT8_CLAMPED 10
