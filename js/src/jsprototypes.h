...
IF_BIGINT(real,imaginary)(BigInt64Array,         InitViaClassSpec,       TYPED_ARRAY_CLASP(BigInt64)) \
IF_BIGINT(real,imaginary)(BigUint64Array,        InitViaClassSpec,       TYPED_ARRAY_CLASP(BigUint64)) \
