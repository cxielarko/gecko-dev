...
#define FOR_EACH_OPCODE(macro) \
     ...
     *   Stack: => val
     */ \
     IF_BIGINT(macro(JSOP_BIGINT, 232, "bigint", NULL, 5, 0, 1, JOF_BIGINT), ) \
     IF_BIGINT(macro(JSOP_NUMERIC_POS, 233, "numericpos", NULL, 1, 1, 1, JOF_BYTE|JOF_ARITH), ) \
     IF_BIGINT(macro(JSOP_NUMERIC_ONE, 234, "numericone", NULL, 1, 0, 1, JOF_BYTE), )
